            ...
            resp = await client.post(
                ...
                json={
                    ...
                    "htmlContent": (
                        ...
                        "<p style='margin:5px 0;font-size:13px;color:#fff'>&#9990;&nbsp; 06 79 78 02 39</p>"
                        "<p style='margin:5px 0;font-size:13px;color:#fff'>&#9993;&nbsp; <a href='mailto:contact@green-audit.fr' style='color:#fff;text-decoration:none'>contact@green-audit.fr</a></p>"
                        "<p style='margin:5px 0;font-size:13px;color:#fff'>&#9679;&nbsp; 6 Rue d&rsquo;Armaillé &middot; 75017 PARIS</p>"
                        "<p style='margin:5px 0;font-size:13px;color:#fff'>&#9675;&nbsp; <a href='https://www.green-audit.fr' style='color:#fff;text-decoration:none'>www.green-audit.fr</a></p>"
                        "</td>"
                        "</tr>"
                        "</table>"
                        "</div>"
